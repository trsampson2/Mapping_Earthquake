...
//Create the map object with center, zoom level, and defualt layer.
let map = L.map('mapid', {
    center: [39.5, -98.5],
    zoom: 3,
    layers: [streets]
...
// Turn each feature into a circleMarker on the map.
    ...
    //Then we add the earthquake layers to the map.
...
//Pass the map laers into the layer control and add the layer control to the map.
L.control.layers(baseMaps, overlays).addTo(map);

// Create a sytle for the lines.
let myStyle = {
    color: "red",
    weight: 2
}
